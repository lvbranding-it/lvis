...
function PageFooter({ caseNumber, page, total }: { caseNumber: string; page: number; total: number }) {
  return (
  ...
  return (
    ...
    >
        ...
        <View style={{ paddingHorizontal: 48, paddingTop: 20, paddingBottom: 48 }}>
          <View style={{ borderTopWidth: 1, borderTopColor: '#1E3A5F', paddingTop: 16 }}>
            <Text style={{ fontSize: 9, color: '#475569', lineHeight: 1.6 }}>
              ...
              analysis. Refer to pages 2–6 for image evidence, category scores, technical findings, and recommendations.
            </Text>
          </View>
        </View>
      ...
      <Page size="A4" style={s.page}>
        ...
        <PageFooter caseNumber={caseNumber} page={2} total={6} />
      </Page>
      ...
      <Page size="A4" style={s.page}>
        ...
        <PageFooter caseNumber={caseNumber} page={3} total={6} />
      </Page>
      ...
      <Page size="A4" style={s.page}>
        ...
        <PageFooter caseNumber={caseNumber} page={4} total={6} />
      </Page>
      ...
      <Page size="A4" style={s.page}>
        ...
        <PageFooter caseNumber={caseNumber} page={5} total={6} />
      </Page>
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.pageBody}>
          ...
          {/* Signature block — wrap={false} prevents it from splitting across pages */}
        ...
        <PageFooter caseNumber={caseNumber} page={6} total={6} />
      </Page>
    </Document>
  )
}
